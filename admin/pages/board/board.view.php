                                    ...
                                    <div class="no-admin-content ">
                                        <div class="flex-radio">
                                            <label class="no-items-center" style="margin-right: 2rem;">
                                                <input type="radio" name="is_visible" value="Y" class="no-input--detail"
                                                    <?= (isset($data['is_visible']) && $data['is_visible'] === 'Y') ? 'checked' : '' ?> />
                                                <span>노출</span>
                                            </label>
                                            <label class="no-items-center">
                                                <input type="radio" name="is_visible" value="N" class="no-input--detail"
                                                    <?= (isset($data['is_visible']) && $data['is_visible'] === 'N') ? 'checked' : '' ?> />
                                                <span>비노출</span>
                                            </label>
                                        </div>
                                        <span class="no-admin-info">
