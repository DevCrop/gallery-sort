...
if ($mode == "save") {
		try {
			...
			$result = $stmt->execute([
				...
				':extra16' => $extra_fields[15],
				':extra17' => $extra_fields[16],
				':extra18' => $extra_fields[17],
				':extra19' => $extra_fields[18],
				':extra20' => $extra_fields[19],
				':extra21' => $extra_fields[20]
			]);
	...
	try {
		...
		// 기본 업데이트 쿼리 문자열
			$query = "UPDATE nb_board_manage SET 
				...
				extra_match_field16 = :extra16, extra_match_field17 = :extra17, extra_match_field18 = :extra18, 
				extra_match_field19 = :extra19, extra_match_field20 = :extra20, extra_match_field21 = :extra21";
