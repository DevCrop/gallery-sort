...
try {
    ...
    $query = "
        SELECT 
            a.no, a.board_no, a.is_visible,a.user_no, a.category_no, a.comment_cnt, a.title, a.contents, 
                                    ...
                                    <li class="no-gallery-item">
                                        ...
                                        <div class="no-gallery-item-txt">
                                            ...
                                            <div class="no-state-btn-wrap">
                                                ...
                                                <div class="no-state-btn no-state-visible">
                                                    <button type="button">
                                                        노출
                                                        <i class="fa-solid fa-caret-down"></i>
                                                    </button>
                                                    <div class="no-state-options">
                                                        <button type="button">노출</button>
                                                        <button type="button">비노출</button>
                                                    </div>
                                                </div>

                                                <div class="no-state-btn no-state-contract">
                                                    <button type="button">
                                                        계약완료
                                                        <i class="fa-solid fa-caret-down"></i>
                                                    </button>
                                                    <div class="no-state-options">
                                                        <button type="button">계약완료</button>
                                                        <button type="button">계약가능</button>
                                                    </div>
                                                </div>
