                            ...
                            <div class="no-card-body no-admin-column no-admin-column--detail">
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        ...
                                        <div class="no-banner-image">
                                            <img src="<?= htmlspecialchars($UPLOAD_WDIR_BANNER) ?>/<?= htmlspecialchars($data['b_img_mobile']) ?>"
                                                alt="<?= htmlspecialchars($data['b_title']) ?>" />
                                        </div>
                                        <?php endif; ?>

                                        <div class="no-file-control">
                                            <input type="text" class="no-fake-file" id="fake_banner_file_2"
                                                placeholder="파일을 선택해주세요." readonly disabled />
                                            <div class="no-file-box">
                                                <input type="file" name="b_img_mobile" id="b_img_mobile"
                                                    onchange="document.getElementById('fake_banner_file_2').value = this.value" />
                                                <button type="button" class="no-btn no-btn--main">파일찾기</button>
                                            </div>
                                        </div>
                                        <span class="no-admin-info"><i class="bx bxs-info-circle"></i> 권장 사이즈는 가로 x
                                            세로(712 x 630)입니다. (단위px)</span>
                                        <span class="no-admin-info"><i class="bx bxs-info-circle"></i> 크기는 자동 조절될 수
                                            있습니다.</span>
                                    </div>
                                </div>-->
                                ...
                                <div class="no-admin-block">
                                    <h3 class="no-admin-title">
                                        <label for="b_desc">하단 서브 타이틀</label>
                                    </h3>
                                    <div class="no-admin-content">
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <textarea name="content" id="content"
                                            class="SEditor"><?=$data['b_contents']?></textarea>
                                    </div>
                                </div>
                                <!-- admin-block -->
