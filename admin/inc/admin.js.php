...
<!-- 네이버 스마트에디터2 -->
<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/resource/vendor/smarteditor2/js/service/HuskyEZCreator.js"
    charset="utf-8"></script>
<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/resource/vendor/smarteditor2/smarteditor2.js" charset="utf-8">
</script>